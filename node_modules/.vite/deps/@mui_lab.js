import {
  ...
  usePagination,
  useThemeProps
} from "./chunk-3KD65KYW.js";
import "./chunk-SWCDZQXO.js";
import {
  require_react_dom
...
function deepClone(source) {
  if (React15.isValidElement(source) || !isPlainObject(source)) {
    return source;
  }
  const output = {};
...
var maybeReactUseId2 = React35["useId".toString()];
...
var Badge = React44.forwardRef(function Badge2(props, forwardedRef) {
...
function useButton(parameters = {}) {
  ...
  const [active, setActive] = React45.useState(false);
  const {
    isFocusVisibleRef,
    onFocus: handleFocusVisible,
    onBlur: handleBlurVisible,
...
var Button = React46.forwardRef(function Button2(props, forwardedRef) {
  var _slots$root;
  const {
    action,
    children,
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime9.jsx)(React47.Fragment, {
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime12.jsxs)(React52.Fragment, {
    children: [(0, import_jsx_runtime11.jsx)("div", {
      tabIndex: open ? 0 : -1,
      onFocus: handleFocusSentinel,
      ref: sentinelStart,
      "data-testid": "sentinelStart"
    }), React52.cloneElement(children, {
      ref: handleRef,
      onFocus
...
var FormControl = React54.forwardRef(function FormControl2(props, forwardedRef) {
  var _slots$root;
  const {
    defaultValue,
    children,
  ...
  React54.useEffect(() => setFocused((isFocused) => disabled ? false : isFocused), [disabled]);
  const ownerState = _extends({}, props, {
    disabled,
    error,
    filled,
...
function useFormControlContext() {
  return React55.useContext(FormControlContext);
}
...
var Input = React57.forwardRef(function Input2(props, forwardedRef) {
...
function useTextNavigation(callback) {
  ...
  return React58.useCallback((event) => {
...
function useList(params) {
  ...
  const handleHighlightChange = React59.useCallback((event, value, reason) => {
  ...
  const stateComparers = React59.useMemo(() => ({
    highlightedValue: itemComparer,
    selectedValues: (valuesArray1, valuesArray2) => areArraysEqual(valuesArray1, valuesArray2, itemComparer)
  }), [itemComparer]);
  const handleStateChange = React59.useCallback((event, field, value, reason, state2) => {
  ...
  const listActionContext = React59.useMemo(() => {
    return {
      disabledItemsFocusable,
      disableListWrap,
      focusManagement,
  ...
  const actionContext = React59.useMemo(() => _extends({}, reducerActionContext, listActionContext), [reducerActionContext, listActionContext]);
  const [state, dispatch] = useControllableReducer({
    reducer,
    actionContext,
    initialState,
  ...
  const previousItems = React59.useRef([]);
  React59.useEffect(() => {
  ...
  const getItemState = React59.useCallback((item) => {
...
function useListItem(parameters) {
  ...
  const createHandleClick = React61.useCallback((externalHandlers) => (event) => {
  ...
  const createHandlePointerOver = React61.useCallback((externalHandlers) => (event) => {
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React64.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
  ...
  const reducerActionContext = React64.useMemo(() => ({
    listboxRef: rootRef
  }), [rootRef]);
  const {
...
var Portal = React67.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React67.useState(null);
  const handleRef = useForkRef2(React67.isValidElement(children) ? getReactElementRef2(children) : null, forwardedRef);
  useEnhancedEffect_default2(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React67.isValidElement(children)) {
      ...
      return React67.cloneElement(children, newProps);
    }
    return (0, import_jsx_runtime17.jsx)(React67.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime17.jsx)(React67.Fragment, {
...
var TransitionContext = React68.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React69.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React70.useState(true);
  const hasPendingExitTransition = React70.useRef(false);
  const registeredTransitions = React70.useRef(0);
  const [hasTransition, setHasTransition] = React70.useState(false);
  const previousRequestEnter = React70.useRef(requestEnter);
  React70.useEffect(() => {
  ...
  const handleExited = React70.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React70.useCallback(() => {
...
var PopupContext = React71.createContext(null);
if (true) {
...
var Popup = React72.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
  ...
  const popupContextValue = React72.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
var Menu = React73.forwardRef(function Menu2(props, forwardedRef) {
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React74.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React75.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    slots = {},
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = (_React$useContext = React76.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
var InnerMenuItem = React78.memo(React78.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var MenuItem2 = React78.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
function useModal(parameters) {
  ...
  const modal = React79.useRef({});
  const mountNodeRef = React79.useRef(null);
  const modalRef = React79.useRef(null);
  const handleRef = useForkRef2(modalRef, rootRef);
  const [exited, setExited] = React79.useState(!open);
  ...
  const isTopModal = React79.useCallback(() => manager.isTopModal(getModal()), [manager]);
  ...
  const handleClose = React79.useCallback(() => {
...
var Modal = React80.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    closeAfterTransition = false,
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime24.jsx)(React81.Fragment, {
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React82.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React82.useMemo(() => {
    return {
      min: min2,
      max: max2,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React82.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React83.forwardRef(function NumberInput2(props, forwardedRef) {
...
var OptionGroup = React84.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {}
...
function useOption(params) {
  ...
  const id = useId2(idParam);
  const optionRef = React85.useRef(null);
  const selectOption = React85.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
var InnerOption = React87.memo(React87.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React87.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
var PopperTooltip = React88.forwardRef(function PopperTooltip2(props, forwardedRef) {
  var _slots$root;
  const {
    anchorEl,
    children,
  ...
  const tooltipRef = React88.useRef(null);
  ...
  const handlePopperRefRef = React88.useRef(handlePopperRef);
  useEnhancedEffect_default2(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React88.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React88.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React88.useState(resolveAnchorEl(anchorEl));
  React88.useEffect(() => {
...
var Popper = React88.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
...
function useSelect(props) {
  ...
  const optionValues = React89.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React89.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React89.useCallback((valueToCheck) => {
    var _option$disabled;
    const option = getOptionByValue(valueToCheck);
    return (_option$disabled = option == null ? void 0 : option.disabled) != null ? _option$disabled : false;
  }, [getOptionByValue]);
  const stringifyOption = React89.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const controlledState = React89.useMemo(() => ({
    selectedValues: value,
    open: openProp
  }), [value, openProp]);
  const getItemId = React89.useCallback((itemValue) => {
    var _options$get;
    return (_options$get = options.get(itemValue)) == null ? void 0 : _options$get.id;
  }, [options]);
  const handleSelectionChange = React89.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React89.useCallback((event, newValue) => {
    onHighlightChange == null || onHighlightChange(event, newValue != null ? newValue : null);
  }, [onHighlightChange]);
  const handleStateChange = React89.useCallback((event, field, fieldValue) => {
    if (field === "open") {
  ...
  const getItemDomElement = React89.useCallback((itemId) => {
    var _subitems$get$ref$cur, _subitems$get;
    if (itemId == null) {
      return null;
    }
  ...
  const isInitiallyOpen = React89.useRef(open);
  useEnhancedEffect_default2(() => {
  ...
  const getOptionMetadata = React89.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
  ...
  const contextValue = React89.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime32.jsx)(React91.Fragment, {
...
var Select = React91.forwardRef(function Select2(props, forwardedRef) {
  ...
  const [buttonDefined, setButtonDefined] = React91.useState(false);
  ...
  const handleButtonRefChange = React91.useCallback((element) => {
  ...
  return (0, import_jsx_runtime33.jsxs)(React91.Fragment, {
...
var Slider = React93.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime35.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime34.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime34.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime35.jsxs)(React93.Fragment, {
      ...
      return (0, import_jsx_runtime35.jsxs)(Thumb, _extends({
        ...
        children: [(0, import_jsx_runtime34.jsx)(Input3, _extends({
          ...
          value: values[index2]
        }, inputProps)), ValueLabel ? (0, import_jsx_runtime34.jsx)(ValueLabel, _extends({}, !isHostComponent_default2(ValueLabel) && {
          valueLabelFormat,
          index: index2,
          disabled
        }, valueLabelProps, {
...
var Snackbar = React95.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var Switch = React97.forwardRef(function Switch2(props, forwardedRef) {
...
var TablePaginationActions = React98.forwardRef(function TablePaginationActions2(props, forwardedRef) {
...
var TablePagination = React99.forwardRef(function TablePagination2(props, forwardedRef) {
...
function useTabs(parameters) {
  ...
  const onSelected = React100.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React100.useRef(() => void 0);
  const getTabPanelId = React100.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId2 = React100.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React100.useCallback((lookupFunction) => {
...
var TabsContext = React101.createContext(null);
if (true) {
  TabsContext.displayName = "TabsContext";
}
function useTabsContext() {
  const context = React101.useContext(TabsContext);
  if (context == null) {
...
function TabsProvider(props) {
  ...
  const compoundComponentContextValue = React102.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
  }), [registerItem, getItemIndex, totalSubitemCount]);
  const tabsContextValue = React102.useMemo(() => ({
    direction,
    getTabId: getTabId2,
    getTabPanelId,
    onSelected,
...
var Tabs = React103.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React104.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var TabPanel = React105.forwardRef(function TabPanel2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React106.useCallback((tabValue) => {
    var _subitems$get;
    return (_subitems$get = subitems.get(tabValue)) == null ? void 0 : _subitems$get.id;
  }, [subitems]);
  registerTabIdLookup(tabIdLookup);
  const subitemKeys = React106.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getTabElement = React106.useCallback((tabValue) => {
  ...
  const handleChange = React106.useCallback((event, newValue) => {
    var _newValue$;
    onSelected(event, (_newValue$ = newValue[0]) != null ? _newValue$ : null);
  }, [onSelected]);
  const controlledProps = React106.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React106.useCallback((item) => {
  ...
  const {
    ...
    reducerActionContext: React106.useMemo(() => ({
  ...
  const contextValue = React106.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
function TabsListProvider(props) {
  ...
  const listContextValue = React107.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex
  }), [dispatch, getItemIndex, getItemState]);
  const compoundComponentContextValue = React107.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
  }), [registerItem, getItemIndex, totalSubitemCount]);
...
var TabsList = React108.forwardRef(function TabsList2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
function useTab(parameters) {
  ...
  const tabRef = React109.useRef(null);
  const id = useId2(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
  ...
  const tabMetadata = React109.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var Tab = React110.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled = false,
  ...
  const tabRef = React110.useRef(null);
...
var TextareaAutosize = React111.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const {
    current: isControlled
  } = React111.useRef(value != null);
  const inputRef = React111.useRef(null);
  const handleRef = useForkRef2(forwardedRef, inputRef);
  const heightRef = React111.useRef(null);
  const shadowRef = React111.useRef(null);
  const calculateTextareaStyles = React111.useCallback(() => {
  ...
  const syncHeight = React111.useCallback(() => {
  ...
  return (0, import_jsx_runtime50.jsxs)(React111.Fragment, {
...
function CssAnimation(props) {
  ...
  const hasExited = React112.useRef(true);
  React112.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React112.useCallback((event) => {
...
var CssTransition = React113.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React113.useState(false);
  React113.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React113.useCallback((event) => {
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React114.useRef(false);
  const firstFocus = React114.useRef(true);
  const inputRef = React114.useRef(null);
  const listboxRef = React114.useRef(null);
  const [anchorEl, setAnchorEl] = React114.useState(null);
  const [focusedTag, setFocusedTag] = React114.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React114.useRef(defaultHighlighted);
  ...
  const [focused, setFocused] = React114.useState(false);
  const resetInputValue = React114.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React114.useState(true);
  ...
  const syncHighlightedIndex = React114.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React114.useRef(false);
...
var LoadingButton = React115.forwardRef(function LoadingButton2(inProps, ref) {
  const contextProps = React115.useContext(ButtonGroupContext_default);
...
var LocalizationProvider = React116.forwardRef(function DeprecatedLocalizationProvider() {
  warn11();
  return null;
});
...
var MobileDatePicker = React117.forwardRef(function DeprecatedMobileDatePicker(props, ref) {
  warn12();
  return null;
});
...
var MobileDateRangePicker = React118.forwardRef(function DeprecatedMobileDateRangePicker() {
  warn13();
  return null;
});
...
var MobileDateTimePicker = React119.forwardRef(function DeprecatedMobileDateTimePicker() {
  warn14();
  return null;
});
...
var MobileTimePicker = React120.forwardRef(function DeprecatedMobileTimePicker() {
  warn15();
  return null;
});
...
var MonthPicker = React121.forwardRef(function DeprecatedMonthPicker() {
  warn16();
  return null;
});
...
var Pagination_default2 = React122.forwardRef(function DeprecatedPagination(props, ref) {
  if (!warnedOnce21) {
...
var PaginationItem_default2 = React123.forwardRef(function DeprecatedPaginationItem(props, ref) {
  if (!warnedOnce22) {
...
var CalendarPickerSkeleton = React124.forwardRef(function DeprecatedCalendarPickerSkeleton() {
  warn17();
  return null;
});
...
var PickersDay = React125.forwardRef(function DeprecatedPickersDay() {
  warn18();
  return null;
});
...
var Rating_default2 = React126.forwardRef(function DeprecatedRating(props, ref) {
  if (!warnedOnce25) {
...
var Skeleton_default2 = React127.forwardRef(function DeprecatedSkeleton(props, ref) {
  if (!warnedOnce26) {
...
var SpeedDial_default2 = React128.forwardRef(function DeprecatedSpeedDial(props, ref) {
  if (!warnedOnce27) {
...
var SpeedDialAction_default2 = React129.forwardRef(function DeprecatedSpeedDialAction(props, ref) {
  if (!warnedOnce28) {
...
var SpeedDialIcon_default2 = React130.forwardRef(function DeprecatedSpeedDialIcon(props, ref) {
  if (!warnedOnce29) {
...
var StaticDatePicker = React131.forwardRef(function DeprecatedStaticDatePicker() {
  warn19();
  return null;
});
...
var StaticDateRangePicker = React132.forwardRef(function DeprecatedStaticDateRangePicker() {
  warn20();
  return null;
});
...
var StaticDateTimePicker = React133.forwardRef(function DeprecatedStaticDateTimePicker() {
  warn21();
  return null;
});
...
var StaticTimePicker = React134.forwardRef(function DeprecatedStaticTimePicker() {
  warn22();
  return null;
});
...
var Context = React135.createContext(null);
if (true) {
  Context.displayName = "TabContext";
}
function useUniquePrefix() {
  const [id, setId] = React135.useState(null);
  React135.useEffect(() => {
...
function useTabContext() {
  return React135.useContext(Context);
}
...
var TabList = React136.forwardRef(function TabList2(props, ref) {
  const {
...
var TabPanel3 = React137.forwardRef(function TabPanel4(inProps, ref) {
...
var TimePicker = React138.forwardRef(function DeprecatedTimePicker() {
  warn23();
  return null;
});
...
var TimelineContext = React139.createContext({});
if (true) {
...
var Timeline = React140.forwardRef(function Timeline2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimeline"
  });
...
var TimelineConnector = React141.forwardRef(function TimelineConnector2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineConnector"
  });
...
var TimelineContent = React142.forwardRef(function TimelineContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineContent"
  });
  ...
  } = React142.useContext(TimelineContext_default);
  const ownerState = _extends({}, props, {
...
var TimelineDot = React143.forwardRef(function TimelineDot2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineDot"
  });
...
var TimelineOppositeContent = React144.forwardRef(function TimelineOppositeContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineOppositeContent"
  });
...
var TimelineItem = React145.forwardRef(function TimelineItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineItem"
  });
  ...
  const {
    position: positionContext
  } = React145.useContext(TimelineContext_default);
  let hasOppositeContent = false;
  React145.Children.forEach(props.children, (child) => {
...
var TimelineSeparator = React146.forwardRef(function TimelineSeparator2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineSeparator"
  });
...
var ToggleButton_default2 = React147.forwardRef(function DeprecatedToggleButton(props, ref) {
  if (!warnedOnce35) {
...
var ToggleButtonGroup_default2 = React148.forwardRef(function DeprecatedToggleButtonGroup(props, ref) {
  if (!warnedOnce36) {
...
var TreeItem = React149.forwardRef(function DeprecatedTreeItem() {
  warn24();
  return null;
});
...
var TreeView = React150.forwardRef(function DeprecatedTreeView() {
  warn25();
  return null;
});
...
var Masonry = React151.forwardRef(function Masonry2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiMasonry"
  });
  ...
  const masonryRef = React151.useRef();
  const [maxColumnHeight, setMaxColumnHeight] = React151.useState();
  const isSSR = !maxColumnHeight && defaultHeight && defaultColumns !== void 0 && defaultSpacing !== void 0;
  const [numberOfLineBreaks, setNumberOfLineBreaks] = React151.useState(isSSR ? defaultColumns - 1 : 0);
  const ownerState = _extends({}, props, {
    spacing,
    columns,
    maxColumnHeight,
  ...
  const handleResize = React151.useCallback((masonryChildren) => {
...
true ? Masonry.propTypes = {
   ...
   * @default 4
   */
  columns: import_prop_types48.default.oneOfType([import_prop_types48.default.arrayOf(import_prop_types48.default.oneOfType([import_prop_types48.default.number, import_prop_types48.default.string])), import_prop_types48.default.number, import_prop_types48.default.object, import_prop_types48.default.string]),
  /**
   ...
   */
  defaultColumns: import_prop_types48.default.number,
  /**
   * The default height of the component in px. This is provided for server-side rendering.
   */
  defaultHeight: import_prop_types48.default.number,
  /**
   * The default spacing of the component. Like `spacing`, it is a factor of the theme's spacing. This is provided for server-side rendering.
   */
  defaultSpacing: import_prop_types48.default.number,
  /**
   * Allows using sequential order rather than adding to shortest column
   * @default false
   */
  sequential: import_prop_types48.default.bool,
  /**
